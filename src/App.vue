<template>
  <div>
    <b-container fluid style="text-align:center;background-image:url('https://thehardtimes.net/wp-content/uploads/2019/10/shutterstock_1285747873-copy.jpg')">
      <img
    ...
    >
      ...
      <b-navbar-nav id="navbar" class="mr-auto">
        <b-nav-item><a><router-link to="/"><h4>Montage Merch</h4></router-link></a></b-nav-item>
        <b-nav-item href="#" class="btn btn-light">T-shirt</b-nav-item>
        <b-nav-item href="#" class="btn btn-light">Band</b-nav-item>
      </b-navbar-nav>
